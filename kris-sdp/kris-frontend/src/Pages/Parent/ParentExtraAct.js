...
const ExtraActParent = () => {
  ...
  // // //go to entrolled activities page
  // useEffect(() => {
  //   if (!studentId && !authFailed) {
  //     axios
  //       .get("http://localhost:5001/api/extra-curricular/me", {
  //         headers: {
  ...
  //       });
  //   }
  // }, [studentId, authFailed]);


  //    const handleEnrolledActivities = () => {
  //   if (studentId) {
  //     navigate(`/extra-curricular/${studentId}`);
  //   } else {
