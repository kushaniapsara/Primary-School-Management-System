  ...
  create: (studentData, callback) => {
    const sql = `INSERT INTO Student (
       Full_name, Name_with_initials, Email, Gender, Religion, Date_of_birth, Address, Contact_number, 
                ...
                Documents, password, Admin_ID, Parent_ID, username
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
        ...
        const values = [
            ...
            studentData.Syllabus, studentData.Immunization, studentData.On_any_drugs, studentData.Allergies, 
            studentData.Sisters_brothers_in_same_school, studentData.Joined_date, studentData.Documents, 
            studentData.password, studentData.Admin_ID, studentData.Parent_ID, studentData.username
        ];
