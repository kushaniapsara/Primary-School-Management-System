...
exports.addStudent = (req, res) => {
  upload.single("profilePhoto")(req, res, (err) => {
    ...
    const {
      ...
      onAnyDrugs, allergies, sistersBrothersInSameSchool, enrollmentDate, documents, password, monthly_amount, username,
    ...
    bcrypt.hash(password, SALT_ROUNDS, (err, hashedPassword) => {
      ...
      Parent.create(parentData, (err, parentResult) => {
        ...
        const studentData = {
          ...
          Joined_date: enrollmentDate, Documents: documents, password: hashedPassword, monthly_amount:monthly_amount, Parent_ID: parentID, username: username,
